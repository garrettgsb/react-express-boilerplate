...
export default function Venue({bar}) {
  ...
  return (
    ...
    <main className="venue">
      ...
      <img src={`https://maps.googleapis.com/maps/api/place/photo?photoreference=${bar.photos[0].photo_reference}&sensor=false&maxheight=1000&maxwidth=1000&key=${process.env.REACT_APP_GOOGLE_PHOTO_KEY}`} alt="" />
      </div> 
      ...
      <div className="data"> 
        ...
        <div className="data--values"><strong>Price:</strong>&nbsp;&nbsp;{priceLevel(bar.price_level)}</div> 
        <div className="data--values"><strong>Rating:</strong>&nbsp;&nbsp;{bar.rating}/5</div>
        <div className="data--values--reviews"><strong>Total Reviews:</strong>&nbsp;&nbsp;{bar.user_ratings_total}</div>
