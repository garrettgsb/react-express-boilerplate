...
const UserCard = (props) => {
  ...
  const profileUpdater = () => {
    console.log('profile in usercard', newProfile);
  };
    ...
    return (
      ...
      {props.profile ? profileView : <></>}
        ...
        <div className="user-edit-info p-5">
          ...
          <div className="h-5 border-b-2 border-gray-300 text-2xl text-center my-5">
          </div>
          ...
          <div className='flex items-center my-3'><PencilIcon className="h-5 w-5 text-black" /><span className="text-lg font-semibold">Bio</span></div>
          ...
          <div className='flex items-center my-3'><MapIcon className="h-5 w-5 text-black" /><span className="text-lg font-semibold">Location</span></div>
          ...
          <div className='flex items-center my-3'><AcademicCapIcon className="h-5 w-5 text-black" /><span className="text-lg font-semibold">Education</span></div>
          ...
          <div className='flex items-center my-3'><BriefcaseIcon className="h-5 w-5 text-black" /><span className="text-lg font-semibold">Job</span></div>
