...
export default function Video() {
  return (
    <Segment raised color="olive" className="video" style={{ backgroundColor: "rgba(225, 205, 48, 0.40)", textShadow: "2px 2px 2px #325036", backgroundImage: "url(https://www.transparenttextures.com/patterns/asfalt-light.png)" }} >
