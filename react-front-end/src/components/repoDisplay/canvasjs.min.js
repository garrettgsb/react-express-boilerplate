...
(function () {
  ...
  function Xa(h, l, u) {
    "millisecond" === u
      ...
      : "year" === u && h.setFullYear(h.getFullYear() + 1 * l);
    return h;
  }
  function X(h, l) {
    var u = !1;
  ...
  function Ga(h) {
    if (!h) return h;
    h = h.replace(/^\s\s*/, "");
    for (var l = /\s/, u = h.length; l.test(h.charAt(--u)); );
    return h.slice(0, u + 1);
  }
  function Ba(h) {
    h.roundRect = function (h, u, r, w, ra, D, y, F) {
      y && (this.fillStyle = y);
      ...
      this.beginPath();
      this.moveTo(h + ra, u);
      this.lineTo(h + r - ra, u);
      this.quadraticCurveTo(h + r, u, h + r, u + ra);
      this.lineTo(h + r, u + w - ra);
      this.quadraticCurveTo(h + r, u + w, h + r - ra, u + w);
      this.lineTo(h + ra, u + w);
      this.quadraticCurveTo(h, u + w, h, u + w - ra);
      this.lineTo(h, u + ra);
      this.quadraticCurveTo(h, u, h + ra, u);
      this.closePath();
      y && this.fill();
      F && 0 < D && this.stroke();
    };
  ...
  function N(h, l) {
    ...
    if (
      ...
      for (var r = 0; r < u.length; r++) u[r] *= l;
    else u = [];
    return u;
  }
  function J(h, l, u, w, Ha) {
    w = w || [];
    Ha = r(Ha) ? (hb ? { passive: !1, capture: !1 } : !1) : Ha;
    w.push([h, l, u, Ha]);
    return h.addEventListener
      ? (h.addEventListener(l, u, Ha), u)
      : h.attachEvent
      ? ((w = function (l) {
          l = l || window.event;
          l.preventDefault =
  ...
  function ib(h) {
    if (h._menuButton) h.exportEnabled ? Ma(h._menuButton) : ua(h._menuButton);
    ...
    if (!h._dropdownMenu && h.exportEnabled && w) {
      ...
      u.innerHTML = h._cultureInfo.printText;
      u.style.backgroundColor = h.toolbar.backgroundColor;
      u.style.color = h.toolbar.fontColor;
      h._dropdownMenu.appendChild(u);
      J(
        u,
        "touchstart",
        function (h) {
      ...
      u = document.createElement("div");
      u.style.cssText = "padding: 12px 8px 12px 8px";
      u.innerHTML = h._cultureInfo.saveJPGText;
      u.style.backgroundColor = h.toolbar.backgroundColor;
      u.style.color = h.toolbar.fontColor;
      h._dropdownMenu.appendChild(u);
      J(
      ...
      u = document.createElement("div");
      u.style.cssText = "padding: 12px 8px 12px 8px";
      u.innerHTML = h._cultureInfo.savePNGText;
      u.style.backgroundColor = h.toolbar.backgroundColor;
      u.style.color = h.toolbar.fontColor;
      h._dropdownMenu.appendChild(u);
      J(
  ...
  function $a(h, l, u) {
    h *= ga;
    l *= ga;
    h = u.getImageData(h, l, 2, 2).data;
    l = !0;
    for (u = 0; 4 > u; u++)
      if ((h[u] !== h[u + 4]) | (h[u] !== h[u + 8]) | (h[u] !== h[u + 12])) {
        l = !1;
        break;
      }
  ...
  function Na(h, l, u) {
    if (w && ab) {
      ...
      Sa !== Oa &&
        ...
        (h.style.height = u + "px"),
        r.scale(ga, ga));
    } else (h.width = l), (h.height = u);
  }
  function jb(h) {
    function l() {
      h._creditLink.style && h._creditLink.style.setProperty
        ? h._creditLink.style.setProperty("display", "block", "important")
        : h._creditLink.style &&
          h._creditLink.style.display &&
          (h._creditLink.style.display = "block");
      setTimeout(l, 5e3);
    }
    if (!kb) {
      var u = !1,
  ...
  function pa(h, l) {
    for (var u in l) h.style[u] = l[u];
  }
  function va(h, l, u) {
    l.getAttribute("state") ||
      ((l.style.backgroundColor = h.toolbar.backgroundColor),
    ...
    l.getAttribute("state") !== u &&
      (l.setAttribute("state", u),
      ...
      l.setAttribute("title", h._cultureInfo[u + "Text"]),
      (l.innerHTML =
        "<img style='height:95%; pointer-events: none;' src='" +
        lb[u].image +
        "' alt='" +
        h._cultureInfo[u + "Text"] +
        "' />"));
  }
  function Ma() {
  ...
  function Ua(h, l) {
    Ua.base.constructor.call(this, "Toolbar", "toolbar", l, null, h);
    this.chart = h;
  ...
  function ya(h, l) {
    ya.base.constructor.call(this, "Title", "title", l, null, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
    this.optionsName = "title";
    if (r(this.options.margin) && h.options.subtitles)
      for (var u = h.options.subtitles, w = 0; w < u.length; w++)
        if (
  ...
  function Ja(h, l, u) {
    Ja.base.constructor.call(this, "Subtitle", "subtitles", l, u, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
    ...
    T.fSDec = function (h) {
      for (var l = "", u = 0; u < h.length; u++)
        l += String.fromCharCode(
          Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(u)
        );
      return l;
    };
    T.obj = {
      trVs: "B`ow`rKR!Ush`m!Wdsrhno",
      fntStr:
      ...
      if ("undefined" === typeof T.pro.sCH && !db)
        try {
          var l = new Date().getMonth() % 3,
            u,
            r,
            w = h[T.fSDec(T.obj.cntx)];
          w[T.fSDec(T.obj.txtBl)] = T.fSDec(T.obj.tp);
          w[T.fSDec(T.obj.fnt)] = 11 + T.fSDec(T.obj.fntStr);
          w[T.fSDec(T.obj.fSy)] = T.fSDec(T.obj.grClr);
          u =
            "cm" === T.pos[l] || "um" === T.pos[l]
              ? 0
              : h.width - w[T.fSDec(T.obj.msTxt)](T.fSDec(T.obj.trVs)).width;
          r = "um" === T.pos[l] ? 0 : h.height - 11;
  ...
  var hb = (function () {
    ...
    Aa = (function () {
      ...
      return function (F, N, M) {
        ...
        return (M = N.replace(h, function (m) {
          switch (m) {
            case "D":
              return V;
            case "DD":
        ...
        if (((l = F[L]), "." === l && 0 > N)) N = L;
          ...
          if ("%" === l) D *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (J = !0);
          0 > N
            ? (M.push(l), "#" === l || "0" === l ? H++ : "," === l && R++)
            : (T.push(l), ("#" !== l && "0" !== l) || Q++);
        }
      J &&
        ((l = Math.floor(h)),
        (F = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (V = 0 === h ? 0 : 0 === l ? -(H + F) : String(l).length - H),
        (D /= Math.pow(10, V)));
      0 > N && (N = L);
      D = (h * D).toFixed(Q);
      l = D.split(".");
        ...
        if (((l = M.pop()), "#" === l || "0" === l))
          if ((N++, N === H)) {
            var W = D,
              D = [];
            if ("0" === l)
              for (l = H - Q - (W ? W.length : 0); 0 < l; ) W.unshift("0"), l--;
            for (; 0 < W.length; )
              (u = W.pop() + u),
                J++,
    ...
    Pa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((l = h.offsetX), (u = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((l = h.layerX), (u = h.layerY))
        : ((l = h.pageX - h.target.offsetLeft),
          (u = h.pageY - h.target.offsetTop));
      return { x: l, y: u };
    },
    ab = !0,
    ...
    Oa = 1,
    ga = ab ? Sa / Oa : 1,
    ca = function (h, l, u, r, w, y, D, F, N, M, T, Q, J) {
      "undefined" === typeof J && (J = 1);
      D = D || 0;
      F = F || "black";
      var H = 15 < r - l && 15 < w - u ? 8 : 0.35 * Math.min(r - l, w - u);
      h.beginPath();
      h.moveTo(l, u);
      h.save();
      h.fillStyle = y;
      h.globalAlpha = J;
      h.fillRect(l, u, r - l, w - u);
      h.globalAlpha = 1;
      0 < D &&
        ((J = 0 === D % 2 ? 0 : 0.5),
        h.beginPath(),
        ...
        (h.strokeStyle = F),
        h.moveTo(l, u),
        h.rect(l - J, u - J, r - l + 2 * J, w - u + 2 * J),
        h.stroke());
      h.restore();
      !0 === N &&
        (h.save(),
        ...
        h.lineTo(r, u),
        h.closePath(),
        (D = h.createLinearGradient((r + l) / 2, u + H, (r + l) / 2, u)),
        D.addColorStop(0, y),
      ...
      !0 === M &&
        ...
        h.lineTo(r, w),
        h.closePath(),
        (D = h.createLinearGradient((r + l) / 2, w - H, (r + l) / 2, w)),
        D.addColorStop(0, y),
        D.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = D),
        h.fill(),
      ...
      !0 === T &&
        ...
        h.lineTo(l, w),
        h.closePath(),
        (D = h.createLinearGradient(l + H, (w + u) / 2, l, (w + u) / 2)),
        D.addColorStop(0, y),
      ...
      !0 === Q &&
        ...
        h.lineTo(r - H, w - H),
        h.lineTo(r, w),
        (D = h.createLinearGradient(r - H, (w + u) / 2, r, (w + u) / 2)),
        D.addColorStop(0, y),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (h.fillStyle = D),
        D.addColorStop(0, y),
  ...
  V.prototype.setOptions = function (h, l) {
  ...
  V.prototype.set = function (h, l, r) {
  ...
  V.prototype.addTo = function (h, l, r, w) {
    ...
    if ("undefined" !== typeof h || this.options._isPlaceholder)
      if (
        ...
        var l = this.parent.options[this.optionsName],
          r = l.length;
        this.options._isPlaceholder || (Ca(l), (r = l.indexOf(this.options)));
  ...
  V.prototype.dispatchEvent = function (h, l, r) {
  ...
  Da.prototype.registerSpace = function (h, l) {
    "top" === h
  ...
  Da.prototype.unRegisterSpace = function (h, l) {
    "top" === h
      ? (this._topOccupied -= l.height)
      : "bottom" === h
      ? (this._bottomOccupied -= l.height)
  ...
  ia.prototype._getLineWithWidth = function (h, l, r) {
    h = String(h);
    ...
    if (0 === this.frontSize) y = w = 0;
      ...
      for (; 0 < h.length; ) {
        ...
        var H = y,
          ...
          w = w + D.height,
          h = Ga(h.slice(D.text.length, h.length));
        F && w > F && ((D = l.pop()), (w -= D.height), (y = H));
      }
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((y = l.y2 - 2 - M.height), (J = "bottom")),
          "left" === this.horizontalAlign
            ? (w = l.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = l.x1 + l.width / 2 - M.width / 2)
            : "right" === this.horizontalAlign && (w = l.x2 - 2 - M.width - D),
  ...
  Va.prototype.get = function (h, l) {
    var w = null;
    0 < this.pool.length
      ? ((w = this.pool.pop()), Na(w, h, l))
      : (w = ta(h, l));
    return w;
  };
  ...
  var Qa = {
    ...
    formatNumber: function (h, l, w) {
      w = w || "en";
      if (La[w]) return ea(h, l || "#,##0.##", new Ka(w));
      throw "Unknown Culture Name";
    },
    formatDate: function (h, l, w) {
      w = w || "en";
      if (La[w]) return Aa(h, l || "DD MMM YYYY", new Ka(w));
      throw "Unknown Culture Name";
    },
  };
  ...
  y = Qa.Chart = (function () {
    ...
    function u(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          t = e - 1;
          f = 0 === t ? 0 : t - 1;
          m = t === a.length - 1 ? t : t + 1;
          b =
            (Math.abs(
              (a[m].x - a[f].x) /
                (0 === a[m].x - a[t].x ? 0.01 : a[m].x - a[t].x)
            ) *
              (d - 1)) /
              2 +
            1;
    ...
    function y(a, d, c, b, e, f, m, t, A, k) {
      var p = 0;
      k ? ((m.color = f), (t.color = f)) : (k = 1);
      p = A ? Math.abs(e - c) : Math.abs(b - d);
      p =
        0 < m.trimLength
          ? Math.abs((p * m.trimLength) / 100)
          : Math.abs(p - m.length);
      A ? ((c += p / 2), (e -= p / 2)) : ((d += p / 2), (b -= p / 2));
      var p = 1 === Math.round(m.thickness) % 2 ? 0.5 : 0,
      ...
      a.beginPath();
      A && 0 < t.thickness
        ? (a.moveTo(b - m.thickness / 2, Math.round((c + e) / 2) - n),
          a.lineTo(d + m.thickness / 2, Math.round((c + e) / 2) - n))
        : 0 < t.thickness &&
          (a.moveTo(Math.round((d + b) / 2) - n, c + m.thickness / 2),
          a.lineTo(Math.round((d + b) / 2) - n, e - m.thickness / 2));
      a.stroke();
    ...
    l.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          ...
          var t = this.data[a.dataSeriesIndexes[m]],
            A = 0,
            k = !1,
            p = !1,
            n;
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          for (q = 0; q < n.dataPoints.length; q++) {
            ...
            if (b < ka && !g) null !== n.dataPoints[q].y && (h = b);
            else {
              if (!g && ((g = !0), 0 < q)) {
                q -= 2;
                continue;
    ...
    l.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          var p = this.data[a.dataSeriesIndexes[k]],
            n = 0,
            q = !1,
            g = !1,
            v;
          ...
          if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
            var ka = a.axisX.sessionVariables.newViewportMinimum
              ...
              s = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (k.dataPoints[p].x && k.dataPoints[p].x.getTime) ||
            "dateTime" === k.xValueType
          )
            t = !0;
          for (p = 0; p < k.dataPoints.length; p++) {
            "undefined" === typeof k.dataPoints[p].x &&
              (k.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0));
            k.dataPoints[p].x.getTime
              ? ((t = !0), (b = k.dataPoints[p].x.getTime()))
              : (b = k.dataPoints[p].x);
            if ((e = k.dataPoints[p].y) && e.length) {
            ...
            0 < p &&
              ...
              e &&
                null !== e[0] &&
                k.dataPoints[p - 1].y &&
                null !== k.dataPoints[p - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((v = e[0] / k.dataPoints[p - 1].y[0]),
                    1 > v && (v = 1 / v),
                    d.minDiff > v && 1 !== v && (d.minDiff = v))
                  : ((v = e[0] - k.dataPoints[p - 1].y[0]),
                    0 > v && (v *= -1),
            ...
            if (!(b < ka) || n) {
              ...
              k.dataPoints[p].label &&
                (a.axisX.labels[b] = k.dataPoints[p].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
    ...
    l.prototype.calculateAutoBreaks = function () {
      ...
      function c(a) {
        if (
          ...
          for (
            ...
            var p = e.data[a.dataSeriesIndexes[m]];
            if (!(4 > p.dataPoints.length))
              for (k = 0; k < p.dataPoints.length; k++)
                (g =
                  ...
                  100),
                  (b = p.dataPoints[k].x.getTime
                    ? p.dataPoints[k].x.getTime()
                    : p.dataPoints[k].x),
                  (g = Math.floor((b - c) / g)),
                  b < f[g].min && (f[g].min = b),
                  b > f[g].max && (f[g].max = b);
      ...
      if (f) {
        for (m = 0; m < this.plotInfo.plotTypes.length; m++)
          for (
            f = this.plotInfo.plotTypes[m], t = 0;
        ...
        for (m = 0; m < this._axes.length; m++)
          if (this._axes[m].dataInfo._dataRanges) {
            var A = this._axes[m].dataInfo.min;
            b =
              ((this._axes[m].dataInfo.max + 1 - A) *
                Math.max(
                  parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) ||
                    10,
                  10
            ...
            for (t = 0; t < k.length - 1; t++)
              if (((p = k[t].max), isFinite(p)))
                for (; t < k.length - 1; )
                  if (((A = k[t + 1].min), isFinite(A))) {
                    n = A - p;
            ...
            if (this._axes[m].scaleBreaks.customBreaks)
              for (
                t = 0;
                t < this._axes[m].scaleBreaks.customBreaks.length;
                t++
              )
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[m].scaleBreaks.customBreaks[t].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[m].scaleBreaks.customBreaks[t].endValue) ||
                    (this._axes[m].scaleBreaks.customBreaks[t].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[m].scaleBreaks.customBreaks[t].endValue) ||
      ...
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if (
          ...
          if (this.panEnabled)
            ...
            this.overlaidCanvasCtx.fillRect(b, t, A, k);
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var k = this._indexLabels[a],
          p = k.chartType.toLowerCase(),
          n,
          q,
          t = la("indexLabelFontColor", k.dataPoint, k.dataSeries),
          A = la("indexLabelFontSize", k.dataPoint, k.dataSeries);
        n = la("indexLabelFontFamily", k.dataPoint, k.dataSeries);
        q = la("indexLabelFontStyle", k.dataPoint, k.dataSeries);
        var m = la("indexLabelFontWeight", k.dataPoint, k.dataSeries),
          g = la("indexLabelBackgroundColor", k.dataPoint, k.dataSeries),
          e = la("indexLabelMaxWidth", k.dataPoint, k.dataSeries),
          f = la("indexLabelWrap", k.dataPoint, k.dataSeries),
          v = la("indexLabelLineDashType", k.dataPoint, k.dataSeries),
          h = la("indexLabelLineColor", k.dataPoint, k.dataSeries),
          l = r(k.dataPoint.indexLabelLineThickness)
            ? r(k.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        var E = k.dataPoint.indexLabelFormatter
          ? k.dataPoint.indexLabelFormatter(x)
          ...
          ? k.dataSeries.indexLabelFormatter(x)
          ...
          : null;
        if (null !== E && "" !== E) {
          var s = la("indexLabelPlacement", k.dataPoint, k.dataSeries),
            x = la("indexLabelOrientation", k.dataPoint, k.dataSeries),
            C = k.direction,
            z = k.dataSeries.axisX,
            B = k.dataSeries.axisY,
            u = !1,
            g = new ia(d, {
              x: 0,
              y: 0,
          ...
          g.measureText();
          k.dataSeries.indexLabelMaxWidth = g.maxWidth;
          if ("stackedarea100" === p) {
            if (
              k.point.x < c.x1 ||
              k.point.x > c.x2 ||
            ...
            if (
              k.dataPoint.x < z.viewportMinimum ||
              k.dataPoint.x > z.viewportMaximum ||
              Math.max.apply(null, k.dataPoint.y) < B.viewportMinimum ||
              Math.min.apply(null, k.dataPoint.y) > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= p.indexOf("line") ||
            ...
            if (
              k.dataPoint.x < z.viewportMinimum ||
              k.dataPoint.x > z.viewportMaximum ||
              k.dataPoint.y < B.viewportMinimum ||
              k.dataPoint.y > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= p.indexOf("column") ||
            "waterfall" === p ||
            ("error" === p && !k.axisSwapped)
          ) {
            if (
              k.dataPoint.x < z.viewportMinimum ||
              k.dataPoint.x > z.viewportMaximum ||
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            n = k.point.x - ("horizontal" === x ? t / 2 : 0);
            "inside" !== s
              ? ((e = c.y1),
                (f = c.y2),
                0 < C
                  ...
                  : ((q = k.point.y + A / 2 + m + b),
                    q > f - A - m - b &&
                      ((q =
                        "auto" === s
                          ? Math.min(k.point.y, f) - A / 2 - m - b
                          : f - A / 2 - m - b),
                      (u = q < k.point.y))))
              : ((e = Math.max(k.bounds.y1, c.y1)),
                (f = Math.min(k.bounds.y2, c.y2)),
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ? 0 < C
                      ? Math.max(k.bounds.y1, c.y1) + A / 2 + m
                      : Math.min(k.bounds.y2, c.y2) - A / 2 - m
                    : (Math.max(k.bounds.y1, c.y1) +
                        Math.min(k.bounds.y2, c.y2)) /
                      2),
                0 < C
                  ? ((q = Math.max(k.point.y, b)),
                    q < e &&
                      ("bubble" === p || "scatter" === p) &&
                      (q = Math.max(k.point.y - A - m, c.y1 + m)))
                  : ((q = Math.min(k.point.y, b)),
                    q > f - A - m &&
                      ("bubble" === p || "scatter" === p) &&
                      (q = Math.min(k.point.y + m, c.y2 - A - m))),
                (q = Math.min(q, f)));
          } else
            0 <= p.indexOf("line") ||
            0 <= p.indexOf("area") ||
            0 <= p.indexOf("scatter")
              ...
              "inside" !== s
                ? ((m = c.x1),
                  ...
                  0 > C
                    ? ((n =
                        k.point.x - ("horizontal" === x ? t : t / 2) - e - b),
                      n < m &&
                        ((n =
                          "auto" === s
                            ? Math.max(k.point.x, m) + e + b
                            : m + e + b),
                        (u = n + t > k.point.x)))
                    : ((n =
                        k.point.x + ("horizontal" === x ? 0 : t / 2) + e + b),
                      n > f - t - e - b &&
                        ((n =
                          "auto" === s
                            ? Math.min(k.point.x, f) -
                              ("horizontal" === x ? t : t / 2) -
                              e -
                              b
                            : f - t - e - b),
                        (u = n < k.point.x))))
                : ((m = Math.max(k.bounds.x1, c.x1)),
                  Math.min(k.bounds.x2, c.x2),
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > C
                        ? Math.max(k.bounds.x1, c.x1) + t / 2 + e
                        : Math.min(k.bounds.x2, c.x2) - t / 2 - e
                      : (Math.max(k.bounds.x1, c.x1) +
                          Math.min(k.bounds.x2, c.x2)) /
                        2),
                  (n =
                    0 > C
                      ? Math.max(k.point.x, b) -
                        ("horizontal" === x ? t / 2 : 0)
                      : Math.min(k.point.x, b) - t / 2),
                  (n = Math.max(n, m)));
          "vertical" === x && (q += A / 2);
          g.x = n;
          g.y = q;
          ...
          l &&
            ...
            d.setLineDash && d.setLineDash(N(v, l)),
            d.beginPath(),
            d.moveTo(k.point.x, k.point.y),
            0 <= p.indexOf("bar") || ("error" === p && k.axisSwapped)
              ? d.lineTo(
                  n -
                    (0 < k.direction ? 0 : -t) +
                    ("vertical" === x ? -t / 2 : 0),
              ...
              : 0 <= p.indexOf("column") || ("error" === p && !k.axisSwapped)
              ? d.lineTo(
                  n + ("horizontal" === x ? t / 2 : 0),
                  q +
                    ((0 < k.direction ? A : -A) + ("vertical" === x ? -A : 0)) /
                      2
                )
              : d.lineTo(
                  n + ("horizontal" === x ? t / 2 : 0),
                  q +
                    ((q < k.point.y ? A : -A) + ("vertical" === x ? -A : 0)) / 2
                ),
            d.stroke());
        }
      }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (k = this._indexLabels[a]),
          (g = la("indexLabelBackgroundColor", k.dataPoint, k.dataSeries)),
          (k.dataSeries.indexLabelBackgroundColor = r(g)
            ? w
              ? "transparent"
              : null
            : g);
    ...
    l.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.clip();
        for (var f = [], m, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          var v = k._colorSet,
            h = (v = k.lineColor = k.options.lineColor
              ? k.options.lineColor
              : v[0]);
          c.strokeStyle = v;
          var l = !0,
            ...
            for (var C = !1, s = 0; s < p.length; s++)
              if (
                ...
                if ("number" !== typeof p[s].y)
                  ...
                  s < p.length - 1 &&
                    (h !== (p[s].lineColor || v) ||
                      n !== (p[s].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(x, r),
                    (h = p[s].lineColor || v),
                  ...
                  if (0 < p[s].markerSize || 0 < k.markerSize) {
                    var B = k.getMarkerProperties(s, x, r, c);
                    f.push(B);
                    z = Q(z);
                    w &&
                      f.push({
                  ...
                  s < p.length - 1 &&
                    ...
                    c.setLineDash &&
                      (p[s].lineDashType
                        ...
                        : ((n = k.lineDashType), c.setLineDash(g))));
                  if (0 < p[s].markerSize || 0 < k.markerSize)
                    (z = k.getMarkerProperties(s, x, r, c)),
                      f.push(z),
                      (B = Q(B)),
                      w &&
                        f.push({
    ...
    l.prototype.renderSpline = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        for (var m = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          var A = a.dataSeriesIndexes[t],
            k = this.data[A];
          ...
          b.beginPath();
          if (0 < p.length)
            for (x = !1, l = 0; l < p.length; l++)
              if (
                ((s = p[l].getTime ? p[l].x.getTime() : p[l].x),
                !(
                ...
                if ("number" !== typeof p[l].y)
                  ...
                  x = a.axisY.convertValueToPixel(p[l].y);
                  ...
                  l < p.length - 1 &&
                    (h !== (p[l].lineColor || v) ||
                      n !== (p[l].lineDashType || k.lineDashType)) &&
                    ((h = p[l].lineColor || v),
                    (r[r.length - 1].newStrokeStyle = h),
                    b.setLineDash &&
                      (p[l].lineDashType
                        ? ((n = p[l].lineDashType),
                  ...
                  if (0 < p[l].markerSize || 0 < k.markerSize) {
                    var z = k.getMarkerProperties(l, s, x, b);
                    m.push(z);
                    C = Q(C);
                    w &&
                      m.push({
              ...
              if (
                ...
                m = a.axisX.reversed
                  ...
                  : (m -
                      ...
                      (a.previousDataSeriesCount + p) * n) <<
                    0;
                var l = a.axisX.reversed ? (m - n) << 0 : (m + n) << 0,
                  s;
                0 <= v[f].y ? (s = k) : ((s = t), (t = k));
                t > s && ((b = t), (t = s), (s = b));
                b = v[f].color
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < s.length)
            for (
              var x = 5 < g && l.bevelEnabled ? !0 : !1, k = 0;
              k < s.length;
              k++
            )
              if (
          ...
          if (0 < v.length) {
            ...
            for (f = 0; f < v.length; f++)
              if (
                ...
                m = a.axisY.convertValueToPixel(v[f].y);
                t = a.axisX.reversed
                  ? (t +
                      (a.plotType.totalDataSeries * n) / 2 -
                      (a.previousDataSeriesCount + p) * n) <<
                ...
                b = v[f].color
                  ? v[f].color
                  : g._colorSet[f % g._colorSet.length];
                ca(c, s, t, m, l, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (A[b] = s[k].y + (A[b] ? A[b] : 0)),
                    (p = m[b] ? m[b] : q),
                    (m[b] = z = a.axisY.convertValueToPixel(A[b]));
                else if (
                ...
                b = s[k].color
                  ? s[k].color
                  : l._colorSet[k % l._colorSet.length];
                ca(c, z, r, p, C, b, 0, null, x, !1, !1, !1, l.fillOpacity);
                b = l.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (A[b] = r + (A[b] ? A[b] : 0)),
                    (p = m[b] ? m[b] : q),
                    (m[b] = r = a.axisY.convertValueToPixel(A[b]));
                else if (((p = a.axisY.convertValueToPixel(r)), 0 <= s[k].y)) {
                  var B = f[b] ? f[b] : 0;
                  r = q + B;
                  p += B;
                  a.dataSeriesIndexes.length - 1 === v &&
                ...
                b = s[k].color
                  ? s[k].color
                  : l._colorSet[k % l._colorSet.length];
                ca(c, r, C, p, z, b, 0, null, x, !1, !1, !1, l.fillOpacity);
                b = l.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        z &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (m.lineTo(l, C), m.lineTo(z.x, C), m.closePath(), m.fill()),
          f.beginPath(),
          f.moveTo(l, s),
          m.beginPath(),
          m.moveTo(l, s),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < v.length) {
            ...
            for (var ja = !0; h < v.length; h++)
              if (
                ((r = v[h].x.getTime ? v[h].x.getTime() : v[h].x),
                !(
                ...
                if ("number" !== typeof v[h].y)
                  ...
                  h < v.length - 1 &&
                    (y !== (v[h].lineColor || u) ||
                      c !== (v[h].lineDashType || g.lineDashType)) &&
                    (b(),
                    (y = v[h].lineColor || u),
                    (f.strokeStyle = y),
                    f.setLineDash &&
                  ...
                  0 !== v[h].markerSize &&
                    (0 < v[h].markerSize || 0 < g.markerSize) &&
                    ((r = g.getMarkerProperties(h, l, s, f)),
                    A.push(r),
                    (aa = Q(aa)),
                    w &&
                      A.push({
              ...
              if (
                ...
                "number" !== typeof v[h].y
                  ...
                  : ((l = a.axisX.convertValueToPixel(r)),
                    ...
                    h < v.length - 1 &&
                      (y !== (v[h].lineColor || u) ||
                        S !== (v[h].lineDashType || g.lineDashType)) &&
                      (b(),
                      (y = v[h].lineColor || u),
                      (f.strokeStyle = y),
                      f.setLineDash &&
                    ...
                    0 !== v[h].markerSize &&
                      (0 < v[h].markerSize || 0 < g.markerSize) &&
                      ((aa = g.getMarkerProperties(h, l, s, f)),
                      A.push(aa),
                      (r = Q(r)),
                      w &&
                        A.push({
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  if (
                    ...
                    h = a.axisY.convertValueToPixel(n[f]);
                  } else (h = a.axisY.convertValueToPixel(fa.y)), (h -= ma);
                  k.push({ x: g, y: l - ma });
                  A[f] = l - h;
                  x || aa
                    ? (!x && B.connectNullData
          ...
          if (0 < p.length) {
            ...
            for (var n = 0, q = 0, e = 0; e < p.length; e++)
              if (
                ...
                f = a.axisX.convertValueToPixel(f);
                m = a.axisY.convertValueToPixel(p[e].y);
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var l = !1, l = !!a.axisY.reversed, u = 0;
          ...
          if (0 < E.length)
            for (
              var C = 5 < v && x.bevelEnabled ? !0 : !1, m = 0;
              m < E.length;
              m++
            )
              if (
                (E[m].getTime ? (g = E[m].x.getTime()) : (g = E[m].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !r(E[m].y) &&
                  E[m].y.length &&
                  "number" === typeof E[m].y[0] &&
                  "number" === typeof E[m].y[1] &&
                  "number" === typeof E[m].y[2] &&
                  "number" === typeof E[m].y[3] &&
                  "number" === typeof E[m].y[4] &&
                  5 === E[m].y.length)
              ) {
                t = a.axisX.convertValueToPixel(g);
                h = a.axisY.convertValueToPixel(E[m].y[0]);
                k = a.axisY.convertValueToPixel(E[m].y[1]);
                p = a.axisY.convertValueToPixel(E[m].y[2]);
                n = a.axisY.convertValueToPixel(E[m].y[3]);
                q = a.axisY.convertValueToPixel(E[m].y[4]);
                var z = (t - v / 2) << 0,
                  B = (t + v / 2) << 0,
                  e = E[m].color ? E[m].color : x._colorSet[0],
                  ...
                  S = E[m].whiskerColor
                    ...
                    : e,
                  P =
                    "number" === typeof E[m].whiskerThickness
                      ? E[m].whiskerThickness
                  ...
                  ma = E[m].stemColor
                    ...
                    : e,
                  ba =
                    "number" === typeof E[m].stemThickness
                      ? E[m].stemThickness
                      : "number" === typeof x.options.stemThickness
                      ? x.stemThickness
                      : y,
                  G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                  H = E[m].stemDashType ? E[m].stemDashType : x.stemDashType,
                  J = E[m].lineColor
                    ? E[m].lineColor
                    : E[m].color
                    ? x.lineColor
                    ...
                    : e,
                  M =
                    "number" === typeof E[m].lineThickness
                      ? E[m].lineThickness
                      : "number" === typeof x.options.lineThickness
                      ? x.lineThickness
                      : y,
                  T = E[m].lineDashType ? E[m].lineDashType : x.lineDashType,
                ...
                0 < P &&
                  ...
                  c.stroke(),
                  c.moveTo((t - aa / 2) << 0, h + fa),
                  c.lineTo((t + aa / 2) << 0, h + fa),
                  c.stroke());
                c.restore();
                w &&
                  ((e = Q(O)),
                  ...
                  0 < ba &&
                    (b.moveTo(t - D - G, k),
                    b.lineTo(t - D - G, Math.max(h, n)),
                    b.stroke(),
                    b.moveTo(t - D - G, Math.min(h, n)),
                    b.lineTo(t - D - G, p),
                    b.stroke()),
                  ca(
                    b,
                  ...
                  0 < P &&
                    ...
                    b.stroke(),
                    b.moveTo(t + aa / 2, h + fa),
                    b.lineTo(t - aa / 2, h + fa),
                    b.stroke()));
                (E[m].indexLabel ||
                  x.indexLabel ||
                  E[m].indexLabelFormatter ||
                  x.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: x.type,
                    dataPoint: E[m],
                    dataSeries: x,
                    point: { x: z + (B - z) / 2, y: a.axisY.reversed ? h : n },
                    direction: 1,
                    bounds: {
                      x1: z,
                      y1: Math.min(h, n),
    ...
    l.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < g.length)
            for (
              var v = 5 < k && q.bevelEnabled ? !0 : !1, f = 0;
              f < g.length;
              f++
            )
              if (
                ...
                var l = a.axisX.reversed
                    ? (b +
                        ...
                        (a.previousDataSeriesCount + p) * k) <<
                      0
                    : (b -
                        (a.plotType.totalDataSeries * k) / 2 +
                        (a.previousDataSeriesCount + p) * k) <<
                      0,
                  u = a.axisX.reversed ? (l - k) << 0 : (l + k) << 0,
                  b = g[f].color
                    ? g[f].color
                ...
                ca(c, l, m, u, t, b, 0, b, v, v, !1, !1, q.fillOpacity);
                b = Q(s);
                w &&
                  ca(
                    this._eventManager.ghostCtx,
            ...
            for (var F = C._colorSet, t = 0; t < z.length; t++) {
              ...
              P.thickness =
                "number" === typeof P.thickness
                  ...
                  : 2;
              z[t].getTime ? (l = z[t].x.getTime()) : (l = z[t].x);
              if (
                !(
                ...
                var ja = a.axisX.convertValueToPixel(l);
                b ? (k = ja) : (h = ja);
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < l.length) {
            ...
            for (f = 0; f < l.length; f++)
              if (
                (l[f].getTime ? (k = l[f].x.getTime()) : (k = l[f].x),
                !(
                ...
                m = a.axisY.convertValueToPixel(l[f].y[0]);
                t = a.axisY.convertValueToPixel(l[f].y[1]);
                ...
                h = a.axisX.reversed
                  ...
                  : (h -
                      ...
                      (a.previousDataSeriesCount + n) * p) <<
                    0;
                var u = a.axisX.reversed ? (h - p) << 0 : (h + p) << 0;
                m > t && ((b = m), (m = t), (t = b));
                b = l[f].color
                  ? l[f].color
                  : g._colorSet[f % g._colorSet.length];
                ca(c, m, h, t, u, b, 0, null, Fa, !1, !1, !1, g.fillOpacity);
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var P = p.getMarkerProperties(g, l, u, b);
                    f.push(P);
                    var F = Q(s);
                    w &&
                      f.push({
                    ...
                    P = p.getMarkerProperties(g, l, r, b);
                    f.push(P);
                    F = Q(s);
                    w &&
                      f.push({
            ...
            for (g = !1; n < p.length; n++)
              if (
                ...
                if (
                  ...
                  n < p.length - 1 &&
                    (E !== (p[n].lineColor || x) ||
                      C !== (p[n].lineDashType || k.lineDashType)) &&
                    ((E = p[n].lineColor || x),
                  ...
                  if (
                    0 !== p[n].markerSize &&
                    (0 < p[n].markerSize || 0 < k.markerSize)
                  ) {
                    var D = k.getMarkerProperties(n, q, g, b);
                    f.push(D);
                    var S = Q(y);
                    w &&
                      f.push({
                    ...
                    D = k.getMarkerProperties(n, q, v, b);
                    f.push(D);
                    S = Q(y);
                    w &&
                      f.push({
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < u.length)
            for (
              ...
              if (
                (u[m].getTime ? (p = u[m].x.getTime()) : (p = u[m].x),
                "number" !== typeof u[m].y)
              ) {
                if (0 < m && !C && r.connectNullData)
                  var y =
                    r.options.nullDataLineDashType || !u[m - 1].lineDashType
                      ? r.nullDataLineDashType
                      : u[m - 1].lineDashType;
                C = !0;
              } else {
                h = a.axisX.convertValueToPixel(p);
                l =
                ...
                var S = u[m].color
                  ...
                  ? r.risingColor
                  : r.fallingColor;
                ca(c, h, l, D, k, S, 0, S, E, E, !1, !1, r.fillOpacity);
                e = Q(e);
                w &&
                  ca(
                    this._eventManager.ghostCtx,
                ...
                var P,
                  S = h;
                P =
                  ("undefined" !== typeof u[m].isIntermediateSum &&
                    !0 === u[m].isIntermediateSum) ||
                  ("undefined" !== typeof u[m].isCumulativeSum &&
                    !0 === u[m].isCumulativeSum)
                    ? 0 < u[m].y
                      ? l
                      : k
                    : 0 < u[m].y
    ...
    var Y = function (a, d, c, b, e, f, m, h, l) {
      if (!(0 > c)) {
      ...
      function d() {
        if (k && p) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
            ...
            h.endAngle = h.startAngle + ((2 * Math.PI) / y) * Math.abs(f.y);
        ...
        for (b = 0; b < p.length; b++) {
          ...
          if (d > c) {
            ...
            Y(
              ...
              g[b].center,
              g[b].radius,
              p[b].color ? p[b].color : k._colorSet[b % k._colorSet.length],
              k.type,
              c,
              d,
              k.fillOpacity,
        ...
        if (0 <= a && a < p.length) {
          ...
          m =
            "right" === n.hemisphere
              ...
              : E.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - E.y, 2));
          l = E.x + B * Math.cos(n.midAngle);
          q = E.y + B * Math.sin(n.midAngle);
          q = Math.sqrt(Math.pow(m - l, 2) + Math.pow(c - q, 2));
          l = Math.acos(B / w);
          q = Math.acos((w * w + B * B - q * q) / (2 * B * w));
          c = q < l ? c - n.indexLabelTextBlock.y : 0;
          m = null;
          for (h = 1; h < p.length; h++)
            if (
              ((m = (a - h + g.length) % g.length),
        ...
        for (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (a = 0; a < p.length; a++) {
              var h = g[a];
              h.indexLabelTextBlock.x = E.x + w * Math.cos(h.midAngle);
              h.indexLabelTextBlock.y = E.y + w * Math.sin(h.midAngle);
            ...
            for (a = 0; a < p.length; a++)
              (h = g[a]),
                (w = "pie" === k.type ? 0.7 * B : 0.8 * B),
                (s = E.x + w * Math.cos(h.midAngle)),
                (r = E.y + w * Math.sin(h.midAngle)),
                  ...
                  (!m &&
                    ...
                    ((r =
                      0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, s * r) && f(a, 2 * r)),
                  Math.abs(h.indexLabelTextBlock.x - E.x) < B &&
          ...
          (function () {
            for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < p.length; k++)
              if (((f = !1), (t = g[k]), t.indexLabelText)) {
                ...
                if (null !== m) {
                  ...
                  if ((q = 0 > z)) {
                    ...
                    var l =
                      ...
                      s =
                        h.indexLabelTextBlock.y -
                        h.indexLabelTextBlock.height / 2,
                      v = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width,
                      A =
                        h.indexLabelTextBlock.y +
                        h.indexLabelTextBlock.height / 2;
                    q =
                  ...
                  q
                    ? (0 > a && (a = k),
                      m !== a && ((c = m), (d += -z)),
                      0 === k % Math.max(p.length / 10, 3) && (f = !0))
                    : (f = !0);
                  f &&
                    0 < d &&
                    0 <= a &&
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function e() {
        ...
        for (
          ...
          c = I[m];
          d = c.textBlock;
          b = (a = q(m) < O.length ? I[q(m)] : null) ? a.textBlock : null;
          c = c.height;
          a && d.y + c + da > b.y && (e = !0);
        ...
        if (e)
          for (m = I.length - 1; 0 <= m; m--)
            (a = O[m]),
              (I[m].textBlock.maxWidth = f[f.length - (m + 1)]),
              I[m].textBlock.measureText(),
              (I[m].textBlock.x = J - k),
              (c =
                I[m].textBlock.height < I[m].textBlock.maxHeight
                  ? I[m].textBlock.height
                  : I[m].textBlock.maxHeight),
              (e =
                I[m].textBlock.width < I[m].textBlock.maxWidth
                  ? I[m].textBlock.width
                  : I[m].textBlock.maxWidth),
              (I[m].height = c),
              (I[m].width = e),
              (c =
                "undefined" !== typeof a.x5
                  ? (a.y2 + a.y4) / 2
                  : (a.y2 + a.y3) / 2),
              (I[m].textBlock.y = c - I[m].height / 2),
              s.reversed
                ? (I[m].textBlock.y + I[m].height > na + C &&
                    (I[m].textBlock.y = na + C - I[m].height),
                  I[m].textBlock.y < sa - C && (I[m].textBlock.y = sa - C))
                : (I[m].textBlock.y < na - C && (I[m].textBlock.y = na - C),
                  I[m].textBlock.y + I[m].height > sa + C &&
                    (I[m].textBlock.y = sa + C - I[m].height));
      }
      function f() {
        var a, b, c, d;
      ...
      function m() {
        ...
        function b() {
          ...
          for (var m, h = 1; h < k; h++) {
            ...
            for (var l = I.length - 1; 0 <= l; l--)
              !I[l].isDirty &&
                ...
                ((m = q(l)),
                !(m >= I.length - 1) &&
                  I[l].textBlock.y + I[l].height + da > I[m].textBlock.y &&
                  (I[l].textBlock.y =
          ...
          for (m = O.length - 1; 0 < m; m--)
            if (!I[m].isDirty) {
              ...
              if (I[m].textBlock.y < I[e].textBlock.y + I[e].height) {
                d = d || m;
                f = m;
                for (
                  k = 0;
        ...
        for (var d, e, f, g, k, m, p = 1, l = 0; l < 2 * p; l++) {
          for (
            var r = I.length - 1;
            0 <= r &&
            !(0 <= n(r) && n(r),
            (f = I[r]),
            (g = f.textBlock),
            (m = (k = q(r) < O.length ? I[q(r)] : null) ? k.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              k &&
              e + d + da > +m.y.toFixed(6) &&
              ((d = g.y + d + da - m.y),
              (e = a(r, -d)),
          ...
          if (-1 !== P) {
            ...
            return {
              ...
              animationCallback: function (a, b) {
                ...
                1 <= a && (l(y, -1, 500), u(y.plotArea.ctx || y.ctx));
              },
              easingFunction: L.easing.easeInQuad,
              animationBase: 0,
            };
    ...
    l.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace("#percent", ea(m, l, f._cultureInfo));
          a = a.replace(
            "#total",
            ea(
              h,
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          g && 0 < g.length && ((k = Ga(g[2])), (a = Ga(g[1])));
        } catch (m) {}
        g = null;
        if ("color" === a)
    ...
    F.prototype.render = function () {
      ...
      for (var h = 0, l = 0; l < m.length; l++) {
        for (var k = m[l], p = 0, n = 0; n < k.items.length; n++) {
          var q = k.items[n],
            g =
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (h = Math.round(f.y2)),
                ...
                (c[g].lineCoordinates.y1 = h - (n[g] + c[g].margin + W)),
                (c[g].lineCoordinates.y2 = h - (n[g] + c[g].margin + W)),
                "inside" === c[g].labelPlacement &&
                  0 < g &&
            ...
            for (g = 0; g < a.length; g++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((l = b[K].lineCoordinates.x1), (m = l - Y));
              a[g].lineCoordinates = {
                x1: l - Q,
                y1: h,
                x2: l - Q,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((l = b[K].lineCoordinates.x2), (m = l - U));
              d[g].lineCoordinates = {
                x1: l + R,
                y1: h,
                x2: l + R,
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var u = 0; u < this.chart.axisX.length; u++) {
                for (
                  var h = this.chart.axisX[u].convertPixelToValue({ y: d }),
                    k = null,
                    b = 0;
                  b < this.chart.axisX[u].dataSeries.length;
                  b++
                )
                  (k = this.chart.axisX[u].dataSeries[b].getDataPointAtX(
                    h,
                    c
                  )) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX[u].dataSeries[b]),
                    null !== k.dataPoint.y && l.push(k));
                k = null;
              }
            if (this.chart.axisX2)
              for (u = 0; u < this.chart.axisX2.length; u++) {
                h = this.chart.axisX2[u].convertPixelToValue({ y: d });
                k = null;
                for (b = 0; b < this.chart.axisX2[u].dataSeries.length; b++)
                  (k = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(
                    h,
                    c
                  )) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX2[u].dataSeries[b]),
                    null !== k.dataPoint.y && l.push(k));
                k = null;
              }
          } else {
            ...
            if (this.chart.axisX)
              for (u = 0; u < this.chart.axisX.length; u++)
                for (
                  h = this.chart.axisX[u].convertPixelToValue({ x: a }),
                    k = null,
                    b = 0;
                  b < this.chart.axisX[u].dataSeries.length;
                  b++
            ...
            if (this.chart.axisX2)
              for (u = 0; u < this.chart.axisX2.length; u++)
                for (
                  h = this.chart.axisX2[u].convertPixelToValue({ x: a }),
                    k = null,
                    b = 0;
          ...
          if ((k = this.chart.getDataPointAtXY(a, d, c)))
            ...
            if (
              ((k = $a(a, d, this.chart._eventManager.ghostCtx)),
              0 < k &&
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, c = null, b = null, e = 0, f = "", h = !0, l = 0;
        l < a.length;
        l++
      )
      ...
      if (
        ...
        for (var r = null, k = "", l = 0; l < a.length; l++)
          (c = a[l].dataSeries),
            (b = a[l].dataPoint),
            (e = a[l].index),
            (f = ""),
