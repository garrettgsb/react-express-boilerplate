        ...
        {fav.map((favourite) => (
          <Card className="favourites-item" key={favourite.id}>
            ...
            <div className="favourites-content">
              ...
              <Button variant="contained" color="primary" onClick={() => handleClick(favourite.building_id)}>
                Building Details
              </Button>
              <Button variant="contained" color="secondary" onClick={() => deleteFavourite(favourite.id)}>
                Remove Favourite
              </Button>
            </div>
          </Card>
