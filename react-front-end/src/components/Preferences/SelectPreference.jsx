...
const SelectPreference = (props) => {
  ...
  if (options.length > 0) {
    ...
    return (
      <div className='bg-white flex flex-col text-sm text-fuchsia-800/70 px-2'>
  ...
  if (options.length < 1 && props.currentOpen.name === 'location') {
    return (
      <div className='bg-white flex flex-col w-full justify-between my-2'>
        <div className='bg-white text-gray-900 my-1'>
  ...
  // age pref settings
  if (options.length < 1 && props.currentOpen.name === 'min_age') {
    return (
      <div className='bg-white flex flex-col w-full justify-between my-2'>
        <div className='bg-white text-gray-900 my-1'>
  ...
  if (options.length < 1 && props.currentOpen.name === 'min_height_in_cm') {
    return (
      <div className='bg-white flex flex-col w-full justify-between my-2'>
        <div className='bg-white text-gray-900 my-1'>
