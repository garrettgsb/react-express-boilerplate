						...
						<div className="m-5 card d-flex align-items-center justify-content-center text-center flex-column">
							...
							<div>
								<button
									...
									className="btn btn-primary mb-3 m-1"
								>
									Confirm
								</button>
								...
								<button
									onClick={() => back()}
									className="btn btn-danger mb-3 m-1"
								>
									Cancel
								</button>
							</div>
						...
						<div className="m-5 card d-flex align-items-center justify-content-center text-center flex-column">
							<table className="table table-bordered">
								<thead>
									<tr>
										<td>
											<h3>Saving for: {goalByID.goal_name}</h3>
										</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td>
											<h3>
												Current end date:
												<br />
												<span className="fw-bold">{goalByID.end_date}</span>
											</h3>
										</td>
									</tr>
								</thead>
