// const connection = require('../routes/trips')
    ...
    for (let dayIndex in trip) {
      ...
      for (const attraction of trip[dayIndex]) {
        ...
        if (attraction.attraction_id) {
          console.log('attraction id', attraction.attraction_id)
          // update start_time
          ...
          db.query(`
            ...
            WHERE itinerary_id = $3 AND attraction_id = $4
            RETURNING *;
          `, [attraction.start_time, attraction.end_time, attraction.itinerary_id, attraction.attraction_id])
