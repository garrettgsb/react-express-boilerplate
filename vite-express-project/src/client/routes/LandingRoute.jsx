      ...
      <div className="flex flex-row items-center p-10 justify-center">
        <article className="p-4 my-15">
          ...
          <div className="inline-flex space-x-6 w-full mt-6 sm:w-auto">
            <a
              href="#"
              className="inline-flex items-center justify-center w-full px-7 py-3 py-1 text-white duration-300 bg-button rounded-lg hover:bg-buttonHover focus:ring focus:ring-blue-300 focus:ring-opacity-80"
              onClick={openModal}
            >
              Join Now
            </a>
